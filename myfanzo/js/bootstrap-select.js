    ...
    ! function(e) {
        ...
        function n(t, i) {
            ...
            var l, r = this.each(function() {
                var t = e(this);
                if (t.is("select")) {
                    var i = t.data("selectblog"),
                        r = "object" == typeof s && s;
                    if (i) {
                        if (r)
                            for (var d in r) r.hasOwnProperty(d) && (i.options[d] = r[d])
                    } else {
                        var h = e.extend({}, a.DEFAULTS, e.fn.selectblog.defaults || {}, t.data(), r);
                        h.template = e.extend({}, a.DEFAULTS.template, e.fn.selectblog.defaults ? e.fn.selectblog.defaults.template : {}, t.data().template, r.template), t.data("selectblog", i = new a(this, h, o))
                    }
        ...
        a.VERSION = "1.11.0", a.DEFAULTS = {
            ...
            render: function(t) {
                ...
                void 0 == this.options.title && (this.options.title = ""), "static" == this.options.selectedTextFormat && (o = this.options.title), o || (o = void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText), this.$button.attr("title", e.trim(o.replace(/<[^>]*>?/g, ""))), this.$button.children(".filter-option").html(o), this.$element.trigger("rendered.bs.select")
            },
            setStyle: function(e, t) {
                this.$element.attr("class") && this.$newElement.addClass(this.$element.attr("class").replace(/selectblog|mobile-device|bs-select-hidden|validate\[.*\]/gi, ""));
            ...
            destroy: function() {
                this.$newElement.before(this.$element).remove(), this.$bsContainer ? this.$bsContainer.remove() : this.$menu.remove(), this.$element.off(".bs.select").removeData("selectblog").removeClass("bs-select-hidden selectblog")
            }
        };
        var l = e.fn.selectblog;
        e.fn.selectblog = n, e.fn.selectblog.Constructor = a, e.fn.selectblog.noConflict = function() {
            return e.fn.selectblog = l, this
        }, e(document).data("keycount", 0).on("keydown.bs.select", '.blog-select [data-toggle=dropdown], .blog-select [role="listbox"], .bs-searchbox input', a.prototype.keydown).on("focusin.modal", '.blog-select [data-toggle=dropdown], .blog-select [role="listbox"], .bs-searchbox input', function(e) {
            e.stopPropagation()
        }), e(window).on("load.bs.select.data-api", function() {
            e(".selectblog").each(function() {
                var t = e(this);
                n.call(t, t.data())
            })
        })
